    ...
    <nav className="bg-[#481349] flex items-center justify-between p-1.5 h-10">
      ...
      <div className="min-w-[280px] max-[642px] grow-[2] shrink">
        <Button
          ...
          size="sm"
          className="bg-accen/25 bg-accent-25 w-full justify-start h-7 px-2"
        >
            ...
            <CommandGroup heading="Channels">
              {channels?.map((channel) => (
                <CommandItem
                  ...
                  className="my-1 hover:bg-gray-500 cursor-pointer"
                >
                  {channel.name}
                </CommandItem>
              ))}
                ...
                return (
                  ...
                  >
                    <Avatar className="size-6">
                      ...
                      <AvatarFallback className="aspect-square text-md">
